...
# Path to save the recorded patterns
@export var pattern_save_path: String = "res://resources/user_made_patterns/"

# Default export variables for batch creating patterns
@export var DefaultPoints: int = 0
@export var DefaultEffectName: String = ""
@export var DefaultEffectDescription: String = ""
@export var DefaultEnemyHealthAdjustment: int = 0
@export var DefaultPlayerHealthAdjustment: int = 0
@export var DefaultEnemyStatusEffect: String = ""
@export var DefaultPlayerStatusEffect: String = ""
...
func _save_pattern():
	...
	# Assign the sequence and default values to the Pattern resource
	pattern_resource.Sequence = sequence
	pattern_resource.Points = DefaultPoints
	pattern_resource.EffectName = DefaultEffectName
	pattern_resource.EffectDescription = DefaultEffectDescription
	pattern_resource.EnemyHealthAdjustment = DefaultEnemyHealthAdjustment
	pattern_resource.PlayerHealthAdjustment = DefaultPlayerHealthAdjustment
	pattern_resource.EnemyStatusEffect = DefaultEnemyStatusEffect
	pattern_resource.PlayerStatusEffect = DefaultPlayerStatusEffect

	var save_path = pattern_save_path + "user_pattern_" + DefaultEffectName + "_" + str(index) + ".tres"
